...
<div
  class="relative drop-shadow-xl w-[400px] h-[550px] overflow-hidden rounded-xl bg-[#323132] "
>
  <div
  ...
  <div class="absolute w-[400px] h-[550px] bg-white blur-[50px] -left-1/2 -top-1/2"></div>
</div>
